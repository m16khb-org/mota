...
describe("MapCanvas", () => {
	...
	it("keeps the selected marker ring in Leaflet geometry beside its 44px hit target", () => {
		const stop: BusStop = {
			id: "selected-stop" as BusStop["id"],
		...
		expect(circleMarkerRefs).toHaveLength(3);
		expect(
			circleMarkerRefs.filter(
